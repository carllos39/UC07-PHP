    ...
    public function update(Produto $produto): bool
    {
        $sql = "UPDATE produtos 
                SET nome = :nome, preco = :preco, ativo = :ativo, 
                    dataDeCadastro = :dataDeCadastro, dataDeValidade = :dataDeValidade,fornecedor_id=:fornecedor_id 
                WHERE id = :id";
        $stmt = $this->db->prepare($sql);
...
<!-- SELECT * FROM produtos LEFT JOIN fornecedores on produtos.fornecedor_id = fornecedores.id; -->